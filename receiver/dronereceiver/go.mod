...
require (
	...
	github.com/grafana/grafana-ci-otel-collector/internal/semconv v0.0.0-20250728232919-9f7e4a6957de
	github.com/grafana/grafana-ci-otel-collector/internal/traceutils v0.0.0-20250709143647-9e225ee7fe9b
