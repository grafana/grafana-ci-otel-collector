...
var MetricsInfo = metricsInfo{
	...
	WorkflowJobsCount: metricInfo{
		...
		Attributes: []string{"vcs.repository.name", "ci.github.workflow.job.labels", "ci.github.workflow.job.status", "ci.github.workflow.job.conclusion", "ci.github.workflow.job.head_branch.is_main"},
	},
	WorkflowRunsCount: metricInfo{
		Name:       "workflow.runs.count",
		Attributes: []string{"vcs.repository.name", "ci.github.workflow.run.labels", "ci.github.workflow.run.status", "ci.github.workflow.run.conclusion", "ci.github.workflow.run.head_branch.is_main"},
	},
}
