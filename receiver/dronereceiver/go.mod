...
require (
	...
	github.com/grafana/grafana-ci-otel-collector/internal/semconv v0.0.0-20250716063601-536afa9585a5
	github.com/grafana/grafana-ci-otel-collector/internal/traceutils v0.0.0-20250716063601-536afa9585a5
