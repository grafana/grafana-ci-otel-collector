...
The `docker-compose.yml` file in this directory expects the following environment variables to be set:
...
```bash
docker compose -f ./pkg/dronereceiver/docker-compose.yaml up -d
```
