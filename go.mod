...
require (
	github.com/grafana/grafana-ci-otel-collector/receiver/dronereceiver v0.0.0-20250717094738-39a104dd198b
	github.com/grafana/grafana-ci-otel-collector/receiver/githubactionsreceiver v0.0.0-20250717094738-39a104dd198b
)
